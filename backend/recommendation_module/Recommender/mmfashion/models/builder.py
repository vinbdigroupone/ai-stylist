...
def _build_module(cfg, registry, default_args):
    ...
    print('=====', mmcv.is_str(obj_type))
    print('===== registry.module_dict:', registry.module_dict)
    ...
    print('===== args:', args)
    print('===== obj_type(**args):', obj_type(**args))
...
def build(cfg, registry, default_args=None):
    ...
    print('***** FUNC: build *****')
    print(1)
    print(' ==== isinstance(cfg, list):', isinstance(cfg, list))
