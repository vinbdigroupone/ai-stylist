...
MODEL_PATH = './retrieval_module/pretrained_model'
MODEL_NAME = 'resnet50_model.pkl'

image_index2info = load_inverted_index('./retrieval_module/csv/train_eval.csv')

features = load_npy_file('./retrieval_module/pretrained_model/deep_fashion_features_2.npy')
